...
const StatsDisplay = () => {
  ...
  return (
    <div className="absolute top-[6.5%] right-[33%] flex gap-[1.5cqw] font-mono text-[1.25cqw] tracking-[0.05em] text-hud/50 [text-shadow:0_0_4px_rgba(120,255,245,0.2)] pointer-events-none z-[105]">
