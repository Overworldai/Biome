...
const RawButton = ({
  ...
  return (
    <button
      ...
      type="button"
      className={`
        inline-flex min-w-0 cursor-pointer items-center justify-center overflow-x-clip overflow-y-visible rounded-none
    ...
    >
      {autoShrinkLabel ? (
        <span
          ref={labelWrapRef}
          className="
            flex min-w-0 flex-1 items-center justify-center overflow-x-clip overflow-y-visible text-center
            whitespace-nowrap
          "
        >
