  ...
  return (
    <div className="engine-mode-choice w-3/4 bg-[rgba(10,14,18,0.95)] border border-hud/30 rounded-[1.5cqw] p-[3.75cqh_3.75cqw] z-100 animate-[choiceFadeIn_0.3s_ease-out] shadow-[0_0_20px_rgba(0,0,0,0.4),0_0_10px_rgba(120,255,245,0.08),inset_0_1px_0_rgba(120,255,245,0.1)]">
      <div className="text-center mb-[3.75cqh]">
        <h2 className="font-mono text-[3cqw] text-hud/95 tracking-[0.15em] mt-0 mb-[1.2cqh]">
          WORLD ENGINE SETUP
        </h2>
        <p className="text-[rgba(200,200,200,0.7)] text-[2.1cqw] m-0">
          Choose how to run the World Engine
        </p>
      </div>

      <div className="flex flex-col gap-[2.25cqh] mb-[3.75cqh]">
        <button
          className="choice-option flex items-center gap-[2.25cqw] p-[2.25cqh_2.25cqw] bg-hud/5 border border-hud/40 rounded-[0.9cqw] cursor-pointer transition-all duration-200 ease-in-out text-left hover:bg-hud/10 hover:border-hud/40 disabled:opacity-50 disabled:cursor-not-allowed"
        ...
        >
          ...
          <div className="flex flex-col gap-[0.6cqh]">
            ...
            <span className="text-[1.95cqw] text-[rgba(200,200,200,0.7)]">
              Have Biome set up World Engine for you
            </span>
        ...
        <button
          className="choice-option flex items-center gap-[2.25cqw] p-[2.25cqh_2.25cqw] bg-hud/5 border border-hud/20 rounded-[0.9cqw] cursor-pointer transition-all duration-200 ease-in-out text-left hover:bg-hud/10 hover:border-hud/40 disabled:opacity-50 disabled:cursor-not-allowed"
        ...
        >
          ...
          <div className="flex flex-col gap-[0.6cqh]">
            ...
            <span className="text-[1.95cqw] text-[rgba(200,200,200,0.7)]">
              For experimentation and hacking
            </span>
            {engineDirPath && (
              <span
