    ...
    app: {
      ...
      settings: {
        ...
        sceneAuthoring: {
          ...
          editMode: 'מעבר עריכה',
          editModeDescription:
            'כיצד העריכות מוחלות על העולם הפעיל: איפוס מודל העולם עם הפריים החדש (מהיר, חד), הנפשת האזור שהשתנה כשהוא נופל למקומו (ללא עלות הסקה), או יצירת מעבר וידאו בין המצב הישן לחדש (איטי, קולנועי).',
          editModeReset: 'איפוס',
          editModeFall: 'נפילה',
          editModeTransition: 'מעבר'
        },
        recording: {
          title: 'הקלטת וידאו',
